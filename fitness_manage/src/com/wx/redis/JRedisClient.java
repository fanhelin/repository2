 ...
 * 
 * @todo redis client . 
 * invoke this class to execute redis's commands
 *
 * @author fhr
 * @dateTime 2016 2016-11-23 下午2:16:37
 */

@Repository("jRedisClient")
public class JRedisClient {
	
	 private static final Logger log = Logger.getLogger(JRedisClient.class);

	    @Autowired
	    private IRedisConnect redisDataSource;
	    ...
	    public String set(String key, String value) {
	        ...
	        try {
	            ...
	            redisDataSource.returnConnect(shardedJedis, broken);
	        }
	        return result;
	    }
